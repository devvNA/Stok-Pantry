...
import 'package:stock_pantry/app/core/services/api_endpoint.dart';
import 'package:stock_pantry/app/core/widgets/custom_snackbar.dart';
import 'package:stock_pantry/app/routes/login_routes.dart';
    ...
    _dio.interceptors.add(InterceptorsWrapper(
      ...
      onError: (error, handler) async {
        if (error.response?.statusCode == 401 &&
          ...
          getx.Get.offAllNamed(LoginRoutes.login);
        }
